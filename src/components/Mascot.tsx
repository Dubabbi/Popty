      ...
      <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {pose === 'welcome' && (
          <>
            ...
            {/* Smile */}
            <path d="M 40 58 Q 50 63 60 58" stroke="#404040" strokeWidth="2" fill="none" strokeLinecap="round" />
            {/* Blush */}
        ...
        {pose === 'recommend' && (
          <>
            ...
            {/* Star eyes */}
            <path d="M 42 48 L 43 45 L 44 48 L 47 48 L 44 50 L 45 53 L 42 51 L 39 53 L 40 50 L 37 48 Z" fill="#FFD700" />
            <path d="M 58 48 L 59 45 L 60 48 L 63 48 L 60 50 L 61 53 L 58 51 L 55 53 L 56 50 L 53 48 Z" fill="#FFD700" />
            {/* Excited mouth */}
        ...
        {pose === 'explore' && (
          <>
            ...
            <line x1="66" y1="46" x2="60" y2="52" stroke="#6B8AFF" strokeWidth="2" strokeLinecap="round" />
            {/* Curious eyes */}
            ...
            {/* Small smile */}
            <path d="M 43 58 Q 50 61 57 58" stroke="#404040" strokeWidth="2" fill="none" strokeLinecap="round" />
          </>
        )}
        ...
        {pose === 'reminder' && (
          <>
            {/* Bell */}
            <path d="M 73 35 Q 73 30 78 30 Q 83 30 83 35 L 83 42 Q 83 47 78 47 Q 73 47 73 42 Z" fill="#FFD700" />
            <circle cx="78" cy="49" r="2" fill="#FFD700" />
            <path d="M 76 32 L 80 32" stroke="#404040" strokeWidth="1" />
            {/* Happy closed eyes */}
            <path d="M 38 48 Q 42 50 46 48" stroke="#404040" strokeWidth="2" fill="none" strokeLinecap="round" />
            <path d="M 54 48 Q 58 50 62 48" stroke="#404040" strokeWidth="2" fill="none" strokeLinecap="round" />
            {/* Big smile */}
            <path d="M 38 58 Q 50 65 62 58" stroke="#404040" strokeWidth="2" fill="none" strokeLinecap="round" />
            {/* Blush */}
        ...
        {pose === 'empty' && (
          <>
            ...
            <path d="M 38 48 Q 42 46 46 48" stroke="#404040" strokeWidth="1.5" fill="none" strokeLinecap="round" />
            <path d="M 54 48 Q 58 46 62 48" stroke="#404040" strokeWidth="1.5" fill="none" strokeLinecap="round" />
            {/* Sad mouth */}
            <path d="M 40 62 Q 50 58 60 62" stroke="#404040" strokeWidth="2" fill="none" strokeLinecap="round" />
            {/* Tear */}
        ...
        {pose === 'success' && (
          <>
            {/* Sparkles */}
            <path d="M 25 30 L 26 27 L 27 30 L 30 30 L 27 31 L 28 34 L 25 32 L 22 34 L 23 31 L 20 30 Z" fill="#FFD700" filter="url(#glow)" />
            <path d="M 75 60 L 76 57 L 77 60 L 80 60 L 77 61 L 78 64 L 75 62 L 72 64 L 73 61 L 70 60 Z" fill="#FFD700" filter="url(#glow)" />
            {/* Star eyes */}
            <path d="M 42 48 L 43 45 L 44 48 L 47 48 L 44 50 L 45 53 L 42 51 L 39 53 L 40 50 L 37 48 Z" fill="#FFD700" />
            <path d="M 58 48 L 59 45 L 60 48 L 63 48 L 60 50 L 61 53 L 58 51 L 55 53 L 56 50 L 53 48 Z" fill="#FFD700" />
            {/* Happy open mouth */}
        ...
        <line x1="50" y1="20" x2="50" y2="30" stroke="#FF8BA0" strokeWidth="2" strokeLinecap="round" />
