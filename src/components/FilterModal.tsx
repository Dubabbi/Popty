...
interface FilterModalProps {
  onClose: () => void;
  onApply: (filters: { areas: string[]; categories: string[]; tags: string[]; time: string }) => void;
  initialFilters?: {
    areas?: string[];
    categories?: string[];
    tags?: string[];
...
export function FilterModal({ onClose, onApply, initialFilters = {} }: FilterModalProps) {
  ...
  const tags = ['Reservation Required', 'Free Entry', 'Kid-friendly', 'Photo Zone', 'Limited Edition'];
